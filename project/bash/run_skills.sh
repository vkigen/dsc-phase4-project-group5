...
VECTORIZER_PATH="${VECTORIZER_PATH:-./models/skills/skills_vectorizer.pkl}"   # Default or from environment variable
VECTORS_PATH="${VECTORS_PATH:-./models/skills/skills_vectors.npz}"           # Default or from environment variable
...
OUTPUT_PATH="${OUTPUT_PATH:-./responses/skills/recommendations.json}"  # Default output path or from environment variable
